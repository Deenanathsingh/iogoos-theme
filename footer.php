<div class="clear-fix" style="clear: both"></div>
    <!-- get a quote sidebtn start -->
		<div class="getQuote-btn move_effect get_a_quote">
			<a href="#" class="getQuote-btnAnchor">Get A Quote</a>
		</div>
	...
	<!-- footer section line -->
		...
		<div class="details_textT"><p><strong>PHONE</strong></p><a href="tel:13152150919"><span>+1-315 215 0919</span></a></div>
        </li>
    	<li>
					...
					<div class="col-lg-3">
						<div class="inner">
							<h3>Web Design &amp; Development</h3>
								<ul>
									<li><a href="<?php echo get_home_url();?>/mobile-application-development-services/">Mobile Application Development</a></li>
									<li><a href="<?php echo get_home_url();?>/website-design-services/">Website Designing Services</a></li>
									<li><a href="<?php echo get_home_url();?>/website-development-services/">Website Development</a></li>
									<li><a href="<?php echo get_home_url();?>/php-website-development-services-india//">php-website-development-services</a></li>
					...
					<div class="col-lg-4">
							...
							<div class="middle-col-footerr">
								...
								<div class="read-more-btn">
									<a href="<?php echo get_home_url();?>/about-us/">Read More</a>
								</div>
							</div>
...
<li><a href="https://www.pinterest.com/iogoossolution/" target="_blank"><i class="fab fa-pinterest-p"></i></a>
						...
						<!--<li><a href="https://plus.google.com/u/0/110520645854184198143/about"><i class="fab fa-google-plus-g">
				...
				<div class="login_eng">
					...
					<a href=" javascript:void(0);"><span class="icon_footer icon_footer_4"></span>
		...
		<div class="col-lg-3">
			<div class="inner">
				<h3>Digital Marketing</h3>
					<ul>
						<li><a href="<?php echo get_home_url();?>/pay-per-click-service/">Pay Per Click</a></li>
						<li><a href="<?php echo get_home_url();?>/content-marketing-services/"> Content Marketing</a>
						</li>
						<li><a href="<?php echo get_home_url();?>/social-media-marketing-services/"> Social Media Marketing 
						</a>

					</li>
					<li><a href="<?php echo get_home_url();?>/paid-media/"> Paid Media Advertising</a></li>

					<li><a href="<?php echo get_home_url();?>/seo-services/"> Search Engine Optimization </a>
					<li><a href="<?php echo get_home_url();?>/seo-pricing/"> SEO Pricing</a>
	...
	<div class="inner">
		...
		<h3>Ecommerce</h3>
			<ul>
				...
				<li class=""><a href="<?php echo get_home_url();?>/magento-development-services/">Magento Development Service </a>

			</li>

			<li class=""><a href="<?php echo get_home_url();?>/shopify-development-services/">Shopify Development Services</a>

		</li>

		<li class=""><a href="<?php echo get_home_url();?>/ecommerce-development-service/">Ecommerce Development Services</a></li>
...
<div class="top_header_phoneF top_header_phone">
   <div class="container">
      <ul>
         <li><span class="__span_icon __span_icon_1"><span class="icon_footer icon_footer_1"></span><a href="tel:27110839444"> +27-110839444</a></span></li>
		     <li><span class="__span_icon __span_icon_3"><span class="icon_footer icon_footer_3"></span> <a href="tel:919540007839"> +91-9540007839</a></span></li>
	...
	<div class="container">
		...
		<div class="copyright">Copyright © 2022 <a href="https://www.iogoos.com/">IOGOOS SOLUTION.</a> All rights reserved.
...
<!-- get a quote -->
<?php include 'pop_contact.php'; ?>
<div class="main__wrap">

	<?php //include 'getAquote.php'; ?>

</div>

<?php
include("template_popup.php");
