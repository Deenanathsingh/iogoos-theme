                            ...
                            <div class="col-lg-6">
                                <div class="inner">
                                    ...
                                    <form>
                                        ...
                                        <input type="button" value="Start Your Project"
                                            class="btn_ btn-secondary_ btnprj">
                                        <i class="hide_btn fa fa-long-arrow-right"></i>
                                    </form>
                                    <div class="button_">
                                        <a href="tel:+13152150919" class="btn_ btn-secondary_"><i
                                                class="fa fa-phone"></i> +1-315 215 0919</a>
