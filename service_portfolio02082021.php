					...
					<div class="port">
						...
						<div class="bg-af-b1">
							...
							<a href="javascript:void(0)" class="port-item-<?php echo $i?>" data-port="#port<?php echo $i?>">
								<img data-src="<?php echo wp_get_attachment_image_url($meta['full_image'][0],'portfolio-slide'); ?>" class="img-responsive lazy-image" id="portImg-<?php echo $i?>" data-img="<?php echo wp_get_attachment_image_url($meta['full_image'][0],'portfolio-gallery'); ?>"/>
							</a>
							<div class="portImg-<?php echo $i?>" style="display:none;"><h1><?php echo get_the_title()?> Portfolio</h1>
						<hr/>
